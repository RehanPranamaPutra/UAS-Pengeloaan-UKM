...
<form action="{{ route('anggota.update',$anggota->id) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
    @csrf
    @method('PUT')
    <div>
    ...
    @enderror
        ...
        <a href="{{ route('anggota.index') }}" class="ml-2 text-gray-600 hover:underline">Batal</a>
    </div>
</form>
@endsection
